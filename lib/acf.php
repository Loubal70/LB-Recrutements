...
function LB_recrutements_register_post_types() {
	...
	register_post_type( 'LB_recrutements', $args );

}
add_action( 'init', 'LB_recrutements_register_post_types' ); // Le hook init lance la fonction
