...
function et_divi_load_scripts_styles(){
	...
	wp_enqueue_style( 'louis-problem', get_template_directory_uri() . '/css/404.css', array(), $theme_version);
	endif;
...
if( $pagenow == 'wp-login.php' ){
	wp_enqueue_style('admin-login', get_template_directory_uri().'/css/login.css');
}
